defmodule Mp3Duration do
  ...
  Full credit to the live beats project for this implementation:
  https://github.com/fly-apps/live_beats/blob/master/lib/live_beats/mp3_stat.ex
  """
